...
class Icons(object):
    ...
    leftarrow = qt.QIcon(":/Icons/leftarrow.png")
    rightarrow = qt.QIcon(":/Icons/rightarrow.png")
    ...
    AllReset = qt.QIcon(":/Icons/AllReset.png")
    ResetMPR = qt.QIcon(":/Icons/ResetMPR.png")
